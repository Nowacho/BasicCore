package dev.wacho.basic.misc.cosmetics.color.namecolor;
...
public enum MessageColor {
    ...
    public ItemStack getIcon(Player player, PlayerData playerData) {
        if (playerData.getMessageColor() != null && playerData.getMessageColor().equals(this)) {
            return new ItemBuilder(Material.WOOL)
                    .setName("&a" + getDisplayName())
                    .setDurability(data)
                    .setLore("&7Change the color of your",
                            "&7chat messages to " + getDisplayName() + "&7.",
                            "",
                            player.getDisplayName() + "&7: " + getColor() + "!",
                            "",
                            "&aYou already have this tag selected!"
                            /*"",
                            "&eClick to deactivate the current effect."*/).toItemStack();
            ...
            return new ItemBuilder(Material.WOOL)
                    ...
                    .setLore("&7Change the color of your",
                            ...
                            player.getDisplayName() + "&7: " + getColor() + "!",
                            "",
                            "&aYou already have this tag selected.").toItemStack();
        }
        else {
